...
- Startup call-chain findings now identify CNI, OCI, Kata VM, helper-binary, binary-exec, and per-binary helper bottlenecks from collector-derived `sandbox.startup.*` metrics plus matching spans.
