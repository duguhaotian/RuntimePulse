...
- Diagnostic artifact collector. Generic diagnostic report ingestion is implemented for support-bundle/log/inspect indexes, including host-agent file and command exporter hooks; Docker diagnostics exporter is now available; next work is containerd/crictl exporters and UI artifact workflows.
